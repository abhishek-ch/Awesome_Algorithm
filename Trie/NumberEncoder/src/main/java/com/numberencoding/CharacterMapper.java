...
/**
 * 
 * This class is responsible for mapping each Charcater representation to the number
 * & store everything in a HashTable based datastructure (HashMap used here)
 * 
 * @author abc
 * 
 */
